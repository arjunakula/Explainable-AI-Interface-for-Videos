...
public class IsMoving extends FunctionBase
{

	public IsMoving() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsMoving running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsMoving: unable to parse arguments") ;
        	}
        }
		...
		{
			b = SpatialFunctions.IsMoving(time_data, loc_data, object_agent);
		}		
		
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsMoving ending");
    	}
