...
public class IsCrossing extends FunctionBase
{

	public IsCrossing() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsCrossing running");
    	}
				...
				(object_agent.id.compareTo(object_patient.id)!=0))
		{
			...
			if (bTimeLocOkay)
			{
				b = SpatialFunctions.IsCrossing(time_data, loc_data, object_agent, object_patient);
			}
		}		
		
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsCrossing ending " + b);
    	}
