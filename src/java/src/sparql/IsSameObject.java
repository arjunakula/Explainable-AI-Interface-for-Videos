...
public class IsSameObject extends FunctionBase
{

	public IsSameObject() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsSameObject running");
    	}
		...
		{
			b = SpatialFunctions.IsSameObject(time_data, loc_data, object_agent, object_patient);
		}		
		
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsSameObject ending");
    	}
