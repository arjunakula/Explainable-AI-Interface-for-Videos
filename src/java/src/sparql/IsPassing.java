...
public class IsPassing extends FunctionBase
{

	public IsPassing() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsPassing running");
    	}
				...
				(object_agent.id.compareTo(object_patient.id)!=0))
		{
			...
			//if (bTimeLocOkay)
			{
				b = SpatialFunctions.IsPassing(time_data, loc_data, object_agent, object_patient);
			}
		}		
		...
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsPassing ending " + b);
    	}
