...
public class IsTurningRight extends FunctionBase
{

	public IsTurningRight() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsTurningRight running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsTurningRight: unable to parse arguments") ;
        	}
        }
		...
		{
			b = SpatialFunctions.IsTurningRight(time_data, loc_data, object_agent);
		}		
		
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsTurningRight ending");
    	}
