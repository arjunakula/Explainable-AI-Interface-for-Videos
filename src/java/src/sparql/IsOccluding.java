...
public class IsOccluding extends FunctionBase
{

	public IsOccluding() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsOccluding running");
    	}
				...
				)
		{
			...
			//if (bTimeLocOkay)
			{
				b = SpatialFunctions.IsOccluding(time_data, loc_data, object_agent, object_object1, object_object2);
			}
		}		
		...
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsOccluding ending " + b);
    	}
