...
public class IsOppositeMotion extends FunctionBase
{

	public IsOppositeMotion() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsOppositeMotion running");
    	}
				...
				(object_agent.id.compareTo(object_patient.id)!=0))
		{
			...
			//if (bTimeLocOkay)
			{
				b = SpatialFunctions.IsOppositeMotion(time_data, loc_data, object_agent, object_patient);
			}
		}		
		...
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsOppositeMotion ending");
    	}
