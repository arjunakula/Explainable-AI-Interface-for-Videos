...
public class IsExiting extends FunctionBase
{
	
	public IsExiting() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsExiting running");
    	}
		...
		for (CObjectData object_agent : list_agent)
			...
			{		
				...
				b = SpatialFunctions.IsExiting(time_data, loc_data, object_agent, object_patient);
				if (b)
					break;
			}
		...
		*/
		...
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsExiting ending " + b);
    	}
