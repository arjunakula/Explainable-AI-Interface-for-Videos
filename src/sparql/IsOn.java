...
public class IsOn extends FunctionBase
{
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsOn running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsOn: unable to parse arguments") ;
        	}
        }
		...
		for (CObjectData object_agent : list_agent)
			...
			{		
				...
				if (ctr_on%100 ==0)
				{
					System.out.println("DEBUG IsOn ctr_on" + ctr_on);
				}
				
				b = SpatialFunctions.IsOn(time_data, loc_data, object_agent, object_patient);
				if (b)
					break;
			}
		...
		*/
		...
		if ((MseeFunction.bVerbose) || (this.bVerboseThis))
    	{
			System.out.println("DEBUG IsOn ending " + b);
    	}
