...
public class IsOpen extends FunctionBase
{
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsOpen running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsOpen: unable to parse arguments") ;
        	}
        }
		...
		for (CObjectData object_agent : object_list_agent)
		{
			...
			{
				b = SpatialFunctions.IsOpen(time_data, loc_data, object_agent);
				if (b)
				{
					break;
				}
		...
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsOpen ending");
    	}
