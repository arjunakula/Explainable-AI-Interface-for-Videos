...
public class IsMakingUTurn extends FunctionBase
{

	public IsMakingUTurn() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsMakingUTurn running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsMakingUTurn: unable to parse arguments") ;
        	}
        }
		...
		{
			b = SpatialFunctions.IsMakingUTurn(time_data, loc_data, object_agent);
		}		
		
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsMakingUTurn ending");
    	}
