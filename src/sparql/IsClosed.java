...
public class IsClosed extends FunctionBase
{

	public IsClosed() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsClosed running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsClosed: unable to parse arguments") ;
        	}
        }
		...
		for (CObjectData object_agent : object_list_agent)
		{
			...
			{
				b = SpatialFunctions.IsClosed(time_data, loc_data, object_agent);
				if (b)
				{
					break;
				}
		...
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsClosed ending");
    	}
