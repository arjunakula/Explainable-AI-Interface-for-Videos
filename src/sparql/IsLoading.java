...
public class IsLoading extends FunctionBase
{

	public IsLoading() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsLoading running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsLoading: unable to parse arguments") ;
        	}
        }
	...
	//								MseeDataset.CheckObjectAtTimeLocation_AllowNull(object_patient, time_data, loc_data));
			...
			if (bTimeLocOkay)
			{
				b = SpatialFunctions.IsLoading(time_data, loc_data, object_agent, object_patient);
			}
		}		
		...
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsLoading ending");
    	}
