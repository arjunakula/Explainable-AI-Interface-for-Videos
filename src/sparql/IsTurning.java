...
public class IsTurning extends FunctionBase
{

	public IsTurning() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsTurning running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsTurning: unable to parse arguments") ;
        	}
        }
		...
		{
			b = SpatialFunctions.IsTurning(time_data, loc_data, object_agent);
		}		
		
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsTurning ending");
    	}
