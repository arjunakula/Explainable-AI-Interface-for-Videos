...
public class IsStopping extends FunctionBase
{

	public IsStopping() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsStopping running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsStopping: unable to parse arguments") ;
        	}
        }
		...
		{
			b = SpatialFunctions.IsStopping(time_data, loc_data, object_agent);
		}		
		
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsStopping ending");
    	}
