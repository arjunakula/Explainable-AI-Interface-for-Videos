...
public class IsTurningLeft extends FunctionBase
{

	public IsTurningLeft() { super() ; }
    ...
    public final NodeValue exec(List<NodeValue> args) 
    {
    	...
    	{
    		System.out.println("DEBUG IsTurningLeft running");
    	}
        ...
        {	if (MseeFunction.IsObjectType(argType_list.get(i)))
        	...
        	{  throw new ARQInternalErrorException(Utils.className(this)+": IsTurningLeft: unable to parse arguments") ;
        	}
        }
		...
		{
			b = SpatialFunctions.IsTurningLeft(time_data, loc_data, object_agent);
		}		
		
		if (MseeFunction.bVerbose)
    	{
			System.out.println("DEBUG IsTurningLeft ending");
    	}
